  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('employee-management.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          ...
          'oldVals' => [isset($searchingVals) ? $searchingVals['First Name'] : '', isset($searchingVals) ? $searchingVals['department_name'] : '']])
          @endcomponent
        @endcomponent
      </form>
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            @foreach ($employees as $employee)
                <tr role="row" class="odd">
                  <td><img src="../{{$employee->picture }}" width="50px" height="50px" onclick="javascript:this.width=200;this.height=200" ondblclick="javascript:this.width=50;this.height=50"/></td>
